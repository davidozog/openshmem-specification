...
\hline
Accessing non-existent \acp{PE} within a team & Using a \ac{PE} value for a
team member that is not a member of the relevant team within an RMA, AMO,
as the root of a broadcast, etc. results in undefined behavior.
\tabularnewline
\hline
