...
%
\item Clarified that \openshmem reductions on floating-point datatypes are not
    strictly associative and/or commutative.
...
\begin{enumerate}
  ...
  \item Clarified that \openshmem reductions on floating-point datatypes are
     not strictly associative and/or commutative. A future version of the
     \openshmem specification may clarify the behavior of reductions on
