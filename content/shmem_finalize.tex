...
\apidescription{
    ...
    \textcolor{red}{What about shared contexts?  May they be destroyed implicitly by finalize, or \textit{must} \FUNC{shmem\_ctx\_destroy} do that?  What about the default context?}
